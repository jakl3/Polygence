...
DATA_DIR = '/home/jack/Code/GitHub/Polygence/Data/ADNI/extracted'
SAVE_DIR = './NumpyADNI'

def getlabels():
    ''' '''
    labels = {}
    with open('/home/jack/Code/GitHub/Polygence/Data/ADNI/patients.csv', 'r') as file:
...
def main():
    ...
    for index in range(len(image_names)):
        ...
        with open(filename, 'wb') as file:
            print('Saving image size {} to {}...'.format(str(image.shape), filename))
